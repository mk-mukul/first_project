...
def Plot_graph(event):
    ...
    plot2.set_ylabel("Area (in hectares)", color="brown", fontsize=18) # write label of 2nd y axis
...
def select_state():
    ...
    state_button = tk.Button(window, text = "Select state", width=20) # make button
...
def select_district(event):
    ...
    dist_button = tk.Button(window, text = "Select district", width=20) # make button
...
def select_crop(event):
    ...
    crop_button = tk.Button(window, text = "See Graph", width=20) # make button
